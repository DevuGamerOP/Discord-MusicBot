module.exports = {
	...
	adminId: "1071448404137365514", //- Replace UserId with the Discord ID of the admin of the bot
	...
	supportServer: "https://discord.gg/Zx2sJTUMPV", //- Support Server Link
	Issues: "https://discord.gg/Zx2sJTUMPV", //- Bug Report Link
	...
	nodes: [
		{
			...
			host: "lava3.fypmoon.org", //- The host name or IP of the lavalink server.
			port: 14003, // The port that lavalink is listening to. This must be a number!
			password: "oneofremii", //- The password of the lavalink server.
